...
* [Operations](#operations)
    ...
    * [Update Cores, Memory, and Disk](#update-cores-memory-and-disk)
    * [Detach and Reattach a Storage Volume](#detach-and-reattach-a-storage-volume)
    * [List Servers, Volumes, and Virtual Data Centers](#list-servers-volumes-and-virtual-data-centers)
