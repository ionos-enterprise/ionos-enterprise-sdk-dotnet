...
namespace  Model
{
    ...
    /// </summary>
    [DataContract]
    public class Nics : IEquatable<Nics>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Nics" /> class.
        /// </summary>
        public Nics()
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Nics);
        }

        /// <summary>
        /// Returns true if Nics instances are equal
        /// </summary>
        /// <param name="other">Instance of Nics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Nics other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
