...
namespace  Model
{
    ...
    /// </summary>
    [DataContract]
    public class Nic : IEquatable<Nic>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Nic);
        }

        /// <summary>
        /// Returns true if Nic instances are equal
        /// </summary>
        /// <param name="other">Instance of Nic to be compared</param>
        /// <returns>Boolean</returns>
