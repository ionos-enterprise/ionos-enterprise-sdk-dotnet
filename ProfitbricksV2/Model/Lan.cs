...
namespace  Model
{
    ...
    /// </summary>
    [DataContract]
    public class Lan : IEquatable<Lan>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Lan" /> class.
        /// </summary>
        public Lan()
        {
        ...
        public LanProperties Properties { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Lan);
        }

        /// <summary>
        /// Returns true if Lan instances are equal
        /// </summary>
        /// <param name="other">Instance of Lan to be compared</param>
        /// <returns>Boolean</returns>
