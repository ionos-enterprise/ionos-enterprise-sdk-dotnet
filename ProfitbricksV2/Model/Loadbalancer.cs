...
namespace  Model
{
    ...
    /// </summary>
    [DataContract]
    public class Loadbalancer : IEquatable<Loadbalancer>
    {
        /// <summary>
        ...
        public LoadbalancerEntities Entities { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Loadbalancer);
        }

        /// <summary>
        /// Returns true if Loadbalancer instances are equal
        /// </summary>
        /// <param name="other">Instance of Loadbalancer to be compared</param>
        /// <returns>Boolean</returns>
