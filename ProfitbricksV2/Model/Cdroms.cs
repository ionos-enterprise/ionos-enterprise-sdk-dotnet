...
namespace  Model
{
    ...
    /// </summary>
    [DataContract]
    public class Cdroms : IEquatable<Cdroms>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Cdroms" /> class.
        /// </summary>
        public Cdroms()
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Cdroms);
        }

        /// <summary>
        /// Returns true if Cdroms instances are equal
        /// </summary>
        /// <param name="other">Instance of Cdroms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Cdroms other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
