...
namespace  Model
{
    ...
    /// </summary>
    [DataContract]
    public class IpBlock : IEquatable<IpBlock>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IpBlock" /> class.
        /// </summary>
        public IpBlock()
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IpBlock);
        }

        /// <summary>
        /// Returns true if IpBlock instances are equal
        /// </summary>
        /// <param name="other">Instance of IpBlock to be compared</param>
        /// <returns>Boolean</returns>
