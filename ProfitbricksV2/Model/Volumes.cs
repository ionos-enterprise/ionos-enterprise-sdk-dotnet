...
namespace  Model
{
    ...
    /// </summary>
    [DataContract]
    public class Volumes : IEquatable<Volumes>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Volumes);
        }

        /// <summary>
        /// Returns true if Volumes instances are equal
        /// </summary>
        /// <param name="other">Instance of Volumes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Volumes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
